...
int main() {
	...
	//DataStruc<std::string, std::string>* d = new DataStruc<std::string, std::string>();	
	
	//dataStrucAlgo(R"({'Hello this might be a string too': 10000000000000000000000000000000000000000000000.12})", 100);
